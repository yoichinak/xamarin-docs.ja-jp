                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">開始するには</h3>
                                    <p>Android、iOS、および UWP 用アプリを構築しましょう。</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    ...
                                    <p>無料のオンライン学習を利用し、ライブ クラスに参加することができます。</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="platforms">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ユーザー インターフェイス</h3>
                                                    <p>Android、iOS、および Windows 間で使用できる UI コントロールについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>ファイル アクセス、デバイス情報、ハードウェア機能のような一般的なタスクのためのクロスプラットフォーム API。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>データとクラウド サービス</h3>
                                                    <p>データの格納と Microsoft Azure などのクラウド サービスへのアクセスについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Android ユーザー インターフェイス</h3>
                                                    <p>Android で使用できるすべてのユーザー インターフェイス ウィジェットについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Android プラットフォーム機能</h3>
                                                    <p>プラットフォーム固有の機能と Android の最新機能の使用方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>高度な概念と内部構造</h3>
                                                    <p>Xamarin.Android のしくみについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サンプル アプリ</h3>
                                                    <p>すぐに利用できる Android フォンやタブレットのサンプルです。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>iOS ユーザー インターフェイス</h3>
                                                    <p>iOS で使用できるすべての UIKit コントロールについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サンプル アプリ</h3>
                                                    <p>iPhone、iPad、Apple Watch、Apple TV 用のアプリとコード デモを紹介します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mac ユーザー インターフェイス</h3>
                                                    <p>macOS で使用できるすべての AppKit コントロールについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mac プラットフォーム機能</h3>
                                                    <p>プラットフォーム固有の機能と macOS の最新機能の使用方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サンプル アプリ</h3>
                                                    <p>C# を使用して Mac デスクトップ用の開発を始めるときに役立つ macOS サンプル アプリを紹介します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a data-default="true" href="#Cross-Platform">クロスプラットフォーム</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サンプル</h3>
                                                    <p>クロスプラットフォーム Xamarin を試すことができるクロスプラットフォームのビルド済みアプリを紹介します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#graphics-games">グラフィックスとゲーム</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SkiaSharp</h3>
                                                    <p>モバイルとデスクトップ用のクロスプラットフォーム 2D グラフィックス。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Live Player アプリと Visual Studio を使用して数分で Xamarin の使用を開始します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>C# と Xamarin のプラットフォームを対話形式で学習できます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
