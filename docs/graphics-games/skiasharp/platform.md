---
title: SkiaSharp プラットフォーム固有の詳細
description: 'お使いのプラットフォームで SkiaSharp の使用について説明します。 簡単な: ネイティブ アプリケーションの SkSurface 内容を表示する方法の詳細について説明します。'
ms.prod: xamarin
...
## <a name="windows-desktop--mac-desktop"></a>Windows デスクトップ/Mac デスクトップ
