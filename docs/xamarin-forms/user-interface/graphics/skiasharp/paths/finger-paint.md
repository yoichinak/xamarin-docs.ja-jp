---
title: SkiaSharp で本の指の描画
description: この記事では、Xamarin.Forms のアプリケーションで SkiaSharp キャンバス上の描画に指を使用する方法について説明し、サンプル コードを示します。
ms.prod: xamarin
...
ms.locfileid: "35243780"
---
# <a name="finger-painting-in-skiasharp"></a>SkiaSharp で本の指の描画
