...
| <h3>group1</h3>1行以上のテキストを表示します。<p align="center">![ラベルのスクリーンショット](xaml-controls-images/Label.png "group1")</p>[API](xref:Xamarin.Forms.Label)  / [ガイド](~/xamarin-forms/user-interface/text/label.md) | <p valign="center"><pre>&lt;Label Text="Hello, Xamarin.Forms!"<br />       FontSize="Large"<br />       FontAttributes="Italic"<br />       HorizontalTextAlignment="Center" /&gt;</pre></p> |
...
|     |     |
| --- | --- |
| <h3>CheckBox</h3>@No__t_0 値の選択を許可します。<p align="center">![チェックボックスのスクリーンショット](xaml-controls-images/CheckBox.png "CheckBox")</p> [ルビ](~/xamarin-forms/user-interface/checkbox.md) | <p valign="center"><pre>&lt;CheckBox IsChecked="true"<br />          HorizontalOptions="Center"<br />          VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
| <h3>Slider</h3>連続する範囲の `double` 値を選択できるようにします。<p align="center">![スライダーのスクリーンショット](xaml-controls-images/Slider.png "Slider")</p>[API](xref:Xamarin.Forms.Slider)  / [ガイド](~/xamarin-forms/user-interface/slider.md) | <p valign="center"><pre>&lt;Slider Minimum="0"<br />        Maximum="100"<br />        VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
...
| <h3>切り替え</h3>@No__t_0 値の選択を許可します。<p align="center">![スイッチのスクリーンショット](xaml-controls-images/Switch.png "切り替え")</p>[API](xref:Xamarin.Forms.Switch)  / [ガイド](~/xamarin-forms/user-interface/switch.md)| <p valign="center"><pre>&lt;Switch IsToggled="false"<br />        HorizontalOptions="Center"<br />        VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
...
| <h3>エディター</h3>複数行のテキストを入力および編集できます。<p align="center">![エディターのスクリーンショット](xaml-controls-images/Editor.png "group1")</p>[API](xref:Xamarin.Forms.Editor)  / [ガイド](~/xamarin-forms/user-interface/text/editor.md) | <p valign="center"><pre>&lt;Editor VerticalOptions="FillAndExpand" /&gt;</pre></p> |
|     |     |
