...
| <h3>切り替え</h3>`boolean` 値の選択を許可します。<p align="center">![スイッチのスクリーンショット](xaml-controls-images/Switch.png "切り替え")</p>[API](xref:Xamarin.Forms.Switch) / [ガイド](~/xamarin-forms/user-interface/switch.md)| <p valign="center"><pre>&lt;Switch IsToggled="false"<br />        HorizontalOptions="Center"<br />        VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
