...
1. 効果を公開するプラットフォーム固有のクラスを作成します。 詳細については、「 [Platform-Specific クラスの作成](#creating-a-platform-specific-class)」を参照してください。
...
![シャドウ Platform-Specific](images/screenshots.png)
