...
開始する前に、新しいソリューションを作成する Xamarin.Forms か、または既存 Xamarin.Forms のソリューション ( [](/samples/xamarin/xamarin-forms-samples/boxview-gameoflife)例) を使用してください。
