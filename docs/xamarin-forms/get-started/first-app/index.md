...
- [Hello, Xamarin.Forms](~/xamarin-forms/get-started/hello-xamarin-forms/index.md) &ndash; さらに機能的なアプリをビルドする。
- [Hello, Xamarin.Forms マルチスクリーン](~/xamarin-forms/get-started/hello-xamarin-forms-multiscreen/index.md) &ndash; 2 つの画面間を移動するアプリをビルドする。
- [Xamarin.Forms のサンプル](~/xamarin-forms/samples/index.yml) &ndash; コード例とサンプル アプリをダウンロードして実行する。
- [Xamarin.Forms の概要](~/xamarin-forms/get-started/introduction-to-xamarin-forms.md) &ndash; Xamarin.Forms のビギナーズ ガイド。
