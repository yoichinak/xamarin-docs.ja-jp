...
[![ナビゲーションを着用](intro-to-wear-images/2d-picker-sml.png "ナビゲーションを着用")](intro-to-wear-images/2d-picker.png#lightbox)
...
[![Xamarin.Android.Wear v2.0](intro-to-wear-images/wear-nuget-2.0-sml.png "Xamarin.Android.Wear v2.0 NuGet のインストール")](intro-to-wear-images/wear-nuget-2.0.png#lightbox)
