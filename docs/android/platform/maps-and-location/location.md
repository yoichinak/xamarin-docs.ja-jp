...
[![Android マニフェストの必要なアクセス許可の設定のスクリーン ショット](location-images/location-01-xs.png)](location-images/location-01-xs.png)
...
[![Android フォンの設定の配置モード 画面](location-images/location-02.png)](location-images/location-02.png)

場所アプリケーション実行を使用して、次のスクリーン ショットに示します`GetBestProvider`:

[![GetBestProvider アプリが緯度、経度、およびプロバイダーの表示](location-images/location-03.png)](location-images/location-03.png)
