...
![複数のソリューション構成を持つソリューション](multi-process-debugging-images/mpd01-xs.png)
...
![[デバッグ] ツールバーの部分](multi-process-debugging-images/mpd02-xs.png)

1. **ソリューション構成** - [デバッグ] ツールバーの [ソリューション構成] をクリックし、ポップアップ メニューから構成を選択して、ソリューション構成を設定することができます。

    ![ソリューション構成を含むサンプル ポップアップ](multi-process-debugging-images/mpd03-xs.png)
...
3. **デバイス ターゲット** - ソリューションを実行するデバイスを選択します。 プロジェクトごとに別のデバイスまたはエミュレーターを指定することができます。
    ...
    ![プロジェクト用のデバイスを示すポップアップ](multi-process-debugging-images/mpd04-xs.png)
...
![ソリューション構成用の出力パッド](multi-process-debugging-images/mpd05-xs.png)
...
![ソリューション構成用のスレッド パッド](multi-process-debugging-images/mpd06-xs.png)
...
![スレッド パッドでの一時停止または再開](multi-process-debugging-images/mpd08-xs.png)
...
1. Visual Studio for Mac で **[ソリューション オプション]** を開き、 **[実行] > [構成]** の順に選択します。
    ...
    ![[ソリューション オプション] ダイアログの [ソリューション構成]](multi-process-debugging-images/mpd10-xs.png)
...
3. 構成一覧で新しい実行構成を選択します。 **[ソリューション オプション]** ダイアログには、ソリューションの各プロジェクトが表示されます。 デバッグ セッションの開始時に開始する各プロジェクトをオンにします。
    ...
    ![開始するプロジェクトの選択](multi-process-debugging-images/mpd12-xs.png)
