...
description: このドキュメントでは、比較し、Xamarin.Forms の WPF を比較します。 これは、コントロール テンプレート、XAML、バインド インフラストラクチャは、データ テンプレート、ItemsControl、ユーザー コントロール、ナビゲーション、および URL ナビゲーションについて説明します。
author: asb3993
ms.author: amburns
ms.date: 04/26/2017
