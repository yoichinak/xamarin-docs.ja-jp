...
description: このドキュメントでは、-デバイスのクロスプラット フォームのアプリケーションをテスト、テスト_ケースの管理、テストを自動化、単体テストを実行およびアプリの提出プロセスを使用する方法について説明します。
ms.prod: xamarin
...
- Windows 開発者がアクセスする必要があります、 [Windows デベロッパー センター](https://developer.microsoft.com/windows/windows-apps)について、それぞれのアプリを送信します。
