...
これらのスクリーン ショットは、各プラットフォームで利用可能な visual 画面デザイナーを表示します。
 ...
 [ ![](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png "これらのスクリーン ショットが各プラットフォームで利用可能な visual 画面デザイナーを表示します。")](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png)
