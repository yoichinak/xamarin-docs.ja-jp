...
使用してこれらのビュー階層を構築することができます、 [iOS 用の Xamarin デザイナー](~/ios/user-interface/designer/index.md) Visual Studio で、ただし便利なは全体をコードで操作する方法の基本を理解します。 この記事では、コードのみのユーザー インターフェイス開発を始めるためのいくつかの基本的なポイントについて説明します。
