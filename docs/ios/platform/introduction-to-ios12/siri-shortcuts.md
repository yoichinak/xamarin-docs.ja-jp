...
### <a name="adding-the-intent-definition-file-to-your-solution"></a>インテント定義ファイルをソリューションに追加する
...
有効にすると、成功したすべての寄付がロック画面に表示され、Siri 候補のオプションの下に表示されます。 アプリケーションを実行した後に寄付が表示されない場合は、次のトラブルシューティングケースを確認してください。
