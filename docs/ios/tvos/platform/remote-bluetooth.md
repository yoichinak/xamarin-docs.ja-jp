...
|---|---|---|
|**タッチ画面**<br />スワイプして移動し、を押してコンテキストメニューを選択して保持します。|**タップ/スワイプ**<br />フォーカスがある項目間の UI ナビゲーション。<br /><br />**Click**<br />選択した (フォーカスされている) 項目をアクティブにします。|**タップ/スワイプ**<br />ゲームの設計によって異なり、端をタップして D パッドとして使用できます。<br /><br />**Click**<br />主ボタンの機能を実行します。|
