...
Xamarin. Mac C#アプリケーションでと .net を使用する場合、 *Xcode および*で作業する開発者が行うのと同じイメージおよびアイコンツールにアクセスできます。
...
1. **Solution Pad**でプロジェクトの**Resources**フォルダーを右クリックし、[追加] [ > **ファイル**の追加] の順に選択します。 
