...
Xcode でメインの**ストーリーボード**ファイルを編集し、**ウィンドウ**ウィンドウを**id インスペクター**で "NSPanel **" に設定**し、新しい**アシスタント**項目を [**ウィンドウ**] メニューに追加して、それを新しいにアタッチしてみましょう。**Show セグエ**を使用しているウィンドウ:
