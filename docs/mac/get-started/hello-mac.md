...
[![Hello, Mac アプリの実行例](hello-mac-images/run02-sml.png)](hello-mac-images/run02.png#lightbox)
...
- [Xamarin.Mac と Visual Studio for Mac](/visualstudio/mac/installation/) の最新バージョン。
...
1. Visual Studio for Mac を起動します。
    ...
    [![メインの Visual Studio for Mac インターフェイス](hello-mac-images/setup01-sml.png)](hello-mac-images/setup01.png#lightbox)

2. **[新しいプロジェクト...]** ボタンをクリックして **[新しいプロジェクト]** ダイアログ ボックスを開き、 **[Mac]**  >  **[アプリ]**  >  **[Cocoa アプリ]** の順に選択して **[次へ]** ボタンをクリックします。

    [![Cocoa アプリの選択](hello-mac-images/setup02-sml.png)](hello-mac-images/setup02.png#lightbox)

3. **[アプリ名]** に「`Hello_Mac`」と入力し、それ以外はすべて既定値のままにします。 **[次へ]** をクリックします。

    [![アプリの名前の設定](hello-mac-images/setup03-sml.png)](hello-mac-images/setup03.png#lightbox)

4. コンピューター上の新しいプロジェクトの場所を確認します。

    [![新しいソリューションの詳細の確認](hello-mac-images/setup04-sml.png)](hello-mac-images/setup04.png#lightbox)

5. **[作成]** ボタンをクリックします。

Visual Studio for Mac で新しい Xamarin.Mac アプリが作成され、アプリのソリューションに追加される既定のファイルが表示されます。

[![ソリューションの新しい既定のビュー](hello-mac-images/project01-sml.png)](hello-mac-images/project01.png#lightbox)
...
[![Visual Studio for Mac plist エディター](hello-mac-images/infoplist01.png)](hello-mac-images/infoplist01.png#lightbox)
...
[![Visual Studio for Mac 権利エディター](hello-mac-images/entitlements01.png)](hello-mac-images/entitlements01.png#lightbox)
...
[![ソリューション エクスプローラーの Main.storyboard ファイル](hello-mac-images/xcode01.png)](hello-mac-images/xcode01.png#lightbox)

これで、次のスクリーンショットのように Xcode が起動します。

[![既定の Xcode Interface Builder ビュー](hello-mac-images/xcode02.png)](hello-mac-images/xcode02.png#lightbox)
...
[![Xcode での Interface Builder のさまざまなセクション](hello-mac-images/xcode03.png)](hello-mac-images/xcode03.png#lightbox)
...
[![プロパティ インスペクター](hello-mac-images/xcode04.png)](hello-mac-images/xcode04.png#lightbox)
...
[![すべてのインスペクターの概要](hello-mac-images/xcode05.png)](hello-mac-images/xcode05.png#lightbox)
...
[![Xcode ライブラリ インスペクター](hello-mac-images/xcode06.png)](hello-mac-images/xcode06.png#lightbox)
...
1. Xcode で、**ライブラリ** セクションから**ボタン**をドラッグします。
    ...
    [![ライブラリ インスペクターからの NSButton の選択](hello-mac-images/xcode07.png)](hello-mac-images/xcode07.png#lightbox)

2. **Interface Editor** の**ビュー** (**ウィンドウ コントローラー**の下) にボタンをドロップします。

    [![インターフェイス デザインへのボタンの追加](hello-mac-images/xcode08.png)](hello-mac-images/xcode08.png#lightbox)

3. **属性インスペクター**の **Title** プロパティをクリックし、ボタンのタイトルを「**クリックしてください**」に変更します。

    [![ボタンのプロパティの設定](hello-mac-images/xcode09.png)](hello-mac-images/xcode09.png#lightbox)

4. **ライブラリ セクション**から**ラベル**をドラッグします。

    [![ライブラリ インスペクターからのラベルの選択](hello-mac-images/xcode10.png)](hello-mac-images/xcode10.png#lightbox)

5. **Interface Editor** のボタンの横にある**ウィンドウ**にラベルをドラッグします。

    [![インターフェイス デザインへのラベルの追加](hello-mac-images/xcode11.png)](hello-mac-images/xcode11.png#lightbox)

6. ラベルの右ハンドルをつかみ、ウィンドウの端に近づくまでドラッグします。

    [![ラベルのサイズの変更](hello-mac-images/xcode12.png)](hello-mac-images/xcode12.png#lightbox)

7. 追加したボタンを**インターフェイス エディター**で選択し、ウィンドウ下部の**制約エディター** アイコンをクリックします。

    [![ボタンへの制約の追加](hello-mac-images/xcode13.png)](hello-mac-images/xcode13.png#lightbox)
...
11. ラベルを選択し、**制約エディター** アイコンをもう一度クリックします。
    ...
    [![ラベルへの制約の追加](hello-mac-images/xcode14.png)](hello-mac-images/xcode14.png#lightbox)
...
[![インターフェイス階層内の要素の選択](hello-mac-images/xcode15.png)](hello-mac-images/xcode15.png#lightbox)
...
[![Xcode でのソースの表示](hello-mac-images/xcode16-sml.png)](hello-mac-images/xcode16.png#lightbox)
...
1. Xcode の画面の右上の端にある**二連の輪**のボタンをクリックして、**アシスタント エディター**を開きます。
    ...
    [![アシスタント エディターの表示](hello-mac-images/outlet01.png)](hello-mac-images/outlet01.png#lightbox)
...
4. **コード エディター**の上部で、 **[自動リンク]** をクリックし、`ViewController.h` ファイルを選択します。
    ...
    [![正しいファイルの選択](hello-mac-images/outlet02.png)](hello-mac-images/outlet02.png#lightbox)

5. Xcode で正しいファイルが選択されます。

    [![ViewController.h ファイルの表示](hello-mac-images/outlet03.png)](hello-mac-images/outlet03.png#lightbox)
...
7. **インターフェイス エディター**で、キーボードの **Control** キーを押しながら、前述の手順で作成したラベルをクリックしてコード エディターの `@interface ViewController : NSViewController {}` コードのすぐ下にドラッグします。
    ...
    [![ドラッグしてアウトレットを作成](hello-mac-images/outlet04.png)](hello-mac-images/outlet04.png#lightbox)

8. ダイアログ ボックスが表示されます。 **[接続]** を **[アウトレット]** に設定したままにして、 **[名前]** に「`ClickedLabel`」と入力します。

    [![アウトレットの定義](hello-mac-images/outlet05.png)](hello-mac-images/outlet05.png#lightbox)

9. **[接続]** ボタンをクリックして**アウトレット**を作成します。

    [![最終アウトレットの表示](hello-mac-images/outlet06.png)](hello-mac-images/outlet06.png#lightbox)
...
2. **インターフェイス エディター**で、キーボードの **Control** キーを押しながら、前述の手順で作成したボタンをクリックしてコード エディターの `@property (assign) IBOutlet NSTextField *ClickedLabel;` コードのすぐ下にドラッグします。
    ...
    [![ドラッグしてアクションを作成](hello-mac-images/action01.png)](hello-mac-images/action01.png#lightbox)

3. **[接続]** の種類を **[アクション]** に変更します。

    [![アクションの定義](hello-mac-images/action02.png)](hello-mac-images/action02.png#lightbox)

4. **[名前]** に「`ClickedButton`」を入力します。

    [![新しいアクションの名前付け](hello-mac-images/action03.png)](hello-mac-images/action03.png#lightbox)

5. **[接続]** ボタンをクリックして**アクション**を作成します。

    [![最終アクションの表示](hello-mac-images/action04.png)](hello-mac-images/action04.png#lightbox)
...
[![Xcode との変更の同期](hello-mac-images/sync01-sml.png)](hello-mac-images/sync01.png#lightbox)
...
[![Visual Studio for Mac での ViewController.cs ファイルの表示](hello-mac-images/code01-sml.png)](hello-mac-images/code01.png#lightbox)
...
[![デバッグ ビルドの選択](hello-mac-images/run01-sml.png)](hello-mac-images/run01.png#lightbox)
...
[![アプリケーションの実行](hello-mac-images/run02-sml.png)](hello-mac-images/run02.png#lightbox)

ボタンを何回かクリックすると、ラベルのカウントが更新されます。

[![ボタンをクリックした結果の表示](hello-mac-images/run03-sml.png)](hello-mac-images/run03.png#lightbox)
...
[Mac サンプル ギャラリー](/samples/browse/?products=xamarin&term=Xamarin.Mac)には、Xamarin.Mac の学習に役立つすぐに使用できるコード例が含まれています。

ユーザーが一般的な Mac アプリケーションに期待する機能を多数含んでいる完全な Xamarin.Mac アプリの 1 つが、[SourceWriter サンプル アプリ](/samples/xamarin/mac-samples/sourcewriter)です。 SourceWriter は、コードの完了とシンプルな構文の強調表示をサポートするシンプルなソース コード エディターです。
