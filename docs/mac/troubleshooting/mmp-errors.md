...
#### <a name="mm1406-target-framework-0-is-invalid-when-targeting-xamarinmac-45-net-framwork"></a>MM1406: ターゲットフレームワーク '{0}' は、Xamarin 4.5 .NET framwork をターゲットにしている場合は無効です。
