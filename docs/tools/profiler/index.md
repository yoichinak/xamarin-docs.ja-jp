...
> [!NOTE]
> ある必要があります、 [Visual Studio Enterprise](https://visualstudio.microsoft.com/vs/compare/) mac 上の Mac の Windows 上のいずれかの Visual Studio Enterprise または Visual Studio でこの機能のロックを解除するサブスクライバー
